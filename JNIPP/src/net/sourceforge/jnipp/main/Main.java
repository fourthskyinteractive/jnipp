 ...
 *
 * This class provides a <code>main()</code> method that accepts a project file
 * name as parameter, attempts to open the file and, if successful, will invoke
 * the code generators as specified therein.
 *
...
public class Main 
{
	 ...
	 * Public entry point.
	 *
	 * This <code>main()</code> method will attempt to load the project file
	 * identified by the <code>projectFile</code> argument from the command line.
	 * It will delegate to the <code>generate()</code> method to coordinate the
	 * code generation.
	 *
	 ...
	 *
	 * This method is called by the <code>main()</code> method to invoke the
	 * code generations as specified by the project file that has been read in.
	 *
