 ...
 * all of the activities required to generate native C++ proxy classes that can
 * be used to automate their Java counterparts on the other side of the JNI.
 *
...
public class ProxyGenerator
{
	 ...
	 * Public entry point.
	 *
	 * This method is invoked to generate the C++ proxy header and implementation
	 * files for all of the Java classes specified in the supplied settings.
	 *
	 * @param proxyGenSettings The settings used to control the code generation.
	 * @return Collection of all <code>ClassNode</code> instances that were processed.
	 ...
	 *
	 * This method is the workhorse of the code generator.  It is initially called
	 * from the public <code>generate()</code> entry point method, but then also
	 * possibly calls itself recursively, depending on the settings passed in.
	 *
	 * @param classNode The <code>ClassNode</code> of the class for which the proxy
	 * is to be generated.
	 * @param alreadyGenerated Map used to prevent generating already generated proxy.
	 * @param proxyGenSettings The settings used to control the code generation.
	 * @exception ClassNotFoundException
	 * @exception java.io.IOException
	 * @see net.sourceforge.jnipp.common.ClassNode
